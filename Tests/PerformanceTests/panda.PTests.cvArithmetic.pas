unit panda.PTests.cvArithmetic;
...
begin
  ...
  SWStart;
  VecDiv(PCmplx128(@x[0]), @x[0], @res[0], N);
  SWStop;
end;
...
begin
  ...
  SWStart;
  VecAdd(PDouble(x), y, PDouble(res), N);
  SWStop;
end;

procedure TVecMathPerformance.AddScalarToVec_Cmplx128;
var x, res: TArray<TCmplx128>;
    y: TCmplx128;
const N = 1000000;
begin
  ...
  SWStart;
  VecAdd(PCmplx128(x), y, PCmplx128(res), N);
  SWStop;
end;
...
procedure TVecMathPerformance.MulVecByScalar_Cmplx128;
var x, res: TArray<TCmplx128>;
    y: TCmplx128;
const N = 1000000;
begin
  ...
  SWStart;
  VecMul(PCmplx128(x), y, PCmplx128(res), N);
  SWStop;
end;
...
begin
  ...
  SWStart;
  axpy(a, PCmplx128(x), PCmplx128(y), N);
  SWStop;
end;
...
procedure TVecMathPerformance.TestDot_Cmplx;
...
begin
  ...
  SWStart;
  dot(PCmplx128(x), PCmplx128(x), N, res);
  SWStop;
end;
